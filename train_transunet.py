...
class TrainPipeline:
    ...
    def train(self):
        ...
        print(f"开始训练 TransUNet 模型，总共 {cfg.epoch} 个轮次")
...
def main():
    ...
    parser.add_argument('--train_path', type=str, default="./DRIVE_PNG/training", help='训练数据集路径')
    parser.add_argument('--test_path', type=str, default="./DRIVE_PNG/test", help='测试数据集路径')
    parser.add_argument('--model_path', type=str, default=cfg.transunet.model_path, help='模型保存路径')
